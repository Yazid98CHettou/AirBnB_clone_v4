...
class Place(BaseModel, Base):
    """Attr:
        ...
        reviews :Place-Review relationship.
        amenities :Place-Amenity relationship.
        amenity_ids : id list of all linked amenities.
    """
    ...
    if getenv("HBNB_TYPE_STORAGE", None) != "database":
        @property
        def reviews(self):
